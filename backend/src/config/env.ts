...
export const env = {
  ...
  mongoUri: process.env.MONGODB_URI || process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/trustchain',
  jwtSecret: process.env.JWT_SECRET || 'default_trustchain_jwt_secret',
  jwtExpiresIn: process.env.JWT_EXPIRES_IN || '7d',
  adminName: process.env.ADMIN_NAME || 'Platform Administrator',
  adminEmail: process.env.ADMIN_EMAIL || 'admin@fundtogether.org',
